...
<main class="form-signin" style="width: 100%;
	...
	>
  <form >
    <!--img class="mb-4" src="img/KMUTT.svg" alt="" width="200" height="200" --->
    ...
    <button class="w-100 btn btn-lg " type="submit" style="background-color:#212529e3; color:#fff;">Sign in</button>
